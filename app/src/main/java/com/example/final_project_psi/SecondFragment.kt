...
class SecondFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val review1 = Review("Makanan Jawa","Nasi Goreng Jawa","Sultan Hamengkubuwono","Sangat nikmat, jadi rindu desa",4)
        list.add(review1)
        list.add(review1)
        list.add(review1)
        list.add(review1)
        ...
        val rvListReview: RecyclerView = view.findViewById(R.id.rv_review)
