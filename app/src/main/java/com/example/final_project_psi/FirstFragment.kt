...
class FirstFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recipeList.add(Recipe(R.drawable.spagetti,"Spaghetti Bolognese","Kontinental","Devina Hermawan","250 g spaghetti kering\n" +
                "2.5 liter air\n" +
                "\n" +
                "◉ Saus Bolognese:\n" +
                "3 sdm mentega\n" +
        ...
        recipeList.add(Recipe(R.drawable.cottage_pie,"Cottage Pie","Kontinental","Arnold Poernomo","◉ Mashed potato:\n" +
                ...
                "2 lembar bay leaves\n" +
                "Garam lada secukup nya"))
        recipeList.add((Recipe(R.drawable.rendang,"Rendang","Nusantara","Luvita Ho","• 500 gr daging\n" +
                ...
                "• 2 cm kunyit\n" +
                "• 3 cm jahe")))
        recipeList.add((Recipe(R.drawable.cumi,"Cumi Cabai Hijau","Nusantara","Arnold Poernomo","750 gram cumi ukuran sedang.\n" +
                "20 Cabai hijau.\n" +
                ...
                "Gula sesuai selera")))
        recipeList.add((Recipe(R.drawable.phobo,"Pho Mie","Oriental","Devina Hermawan","◉ Daging dan Kuah\n" +
        ...
        recipeList.add((Recipe(R.drawable.tomyam,"Tom Yum Goong","Oriental","Devina Hermawan","1 liter Kaldu Ayam\n" +
                "5 gram Daun Jeruk\n" +
                "2 gram Bawang Putih\n" +
